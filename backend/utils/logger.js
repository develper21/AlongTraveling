...
const customLogger = {
  ...
  service: (serviceName, status, details = '') => {
    if (status === 'connected' || status === 'started') {
      console.log(`[SUCCESS]`.green.bold + ` ${serviceName} ${status}${details ? ` - ${details}` : ''}`);
    } else if (status === 'failed' || status === 'error') {
      console.log(`[FAILED]`.red.bold + ` ${serviceName} ${status}${details ? ` - ${details}` : ''}`);
    } else {
      console.log(`[INFO]`.blue.bold + ` ${serviceName} ${status}${details ? ` - ${details}` : ''}`);
    }
  },
  ...
  database: (operation, status, details = '') => {
    if (status === 'success') {
      console.log(`[DATABASE]`.green.bold + ` ${operation} - success${details ? ` - ${details}` : ''}`);
    } else if (status === 'error') {
      console.log(`[DATABASE]`.red.bold + ` ${operation} - error${details ? ` - ${details}` : ''}`);
    } else {
      console.log(`[DATABASE]`.blue.bold + ` ${operation} - ${status}${details ? ` - ${details}` : ''}`);
    }
  }
};
